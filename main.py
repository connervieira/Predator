...
if (mode_selection == "0" and config["general"]["modes"]["enabled"]["management"] == True): # The user has selected to boot into management mode.
    try:
        ...
        working_directory_input = prompt("Working directory (Default " + config["general"]["working_directory"] + "): ", optional=True, input_type=str, default=config["general"]["working_directory"])
        ...
        display_message("Management mode halted.", 1)
...
# Pre-recorded mode
    ...
    try:
        ...
        for file in working_directory_contents:
            if (file[0:len("predator_dashcam_")] == "predator_dashcam_"): # TODO: Replace with new file format.
        ...
        display_message("Pre-recorded analysis halted.", 1)
...
# Real-time mode
    ...
    try:
        ...
        display_message("Real-time ALPR halted.", 1)
